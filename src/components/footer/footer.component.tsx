    ...
    <footer className="footer">
        <div className="footer-container">
            ...
            <div className="footer-section">
                ...
                <div className="description icon-item"><FaClock className='info-icon'/> <span>24/7</span></div>
                <div className="description icon-item"><FaPhone className='info-icon'/> <span>+94 76 00 00 000</span></div>
                <div className="description icon-item">Our Support and Sales team is available <br /> 24/7 to answer your queries</div>
            </div>
        </div>
    </footer>
  )
